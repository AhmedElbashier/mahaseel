from sqlalchemy import String, Integer, Float, ForeignKey, Enum, DateTime, func, Text
...
class Order(Base):
    ...
    buyer_id: Mapped[int] = mapped_column(ForeignKey("users.id", ondelete="SET NULL"), nullable=True, index=True)
